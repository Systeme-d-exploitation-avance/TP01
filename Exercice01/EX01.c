...
int main(int argc, char **argv)
{
  ...
  FILE *source_file = fopen(bin_input_param, "rb"); // Open the source file for reading in binary mode
  if (source_file == NULL)
  {
  ...
  FILE *dest_file = fopen(bin_output_param, "wb");  // Open the destination file for writing in binary mode
  if (dest_file == NULL)
  {
  ...
  free_if_needed(bin_output_param);                 // Free allocated memory
